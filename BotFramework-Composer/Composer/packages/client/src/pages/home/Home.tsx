...
const resources = [
  {
    ...
    title: formatMessage('Über uns'),
    description: formatMessage('Hier kannst du alles über uns als Firma erfahren.'),
    moreText: formatMessage('Homepage '),
    url: 'https://semanticservices.de/',
  },
  {
    imageCover: githubIcon,
    title: formatMessage('Unser LinkedIn'),
    description: formatMessage('Hier kannst du uns bei LinkedIn finden'),
    moreText: formatMessage('LinkedIn'),
    url: 'https://de.linkedin.com/company/semanticservices',
  },
  // {
  //   imageCover: githubIcon,
  //   title: formatMessage('Unser LinkedIn'),
...
const Home: React.FC<RouteComponentProps> = () => {
  ...
  return (
    <div css={home.outline}>
      <div css={home.page}>
        <h1 css={home.title}>{formatMessage(`Willkommen beim Immersive Dialog Editor`)}</h1>
        <div css={home.leftPage} role="main">
          <div css={home.recentBotsContainer}>
            <h2 css={home.subtitle}>{formatMessage(`Version 1.0`)}</h2>
          ...
          <div css={home.resourcesContainer}>
            <h2 css={home.subtitle}>{formatMessage('Ressourcen')}&nbsp;</h2>
